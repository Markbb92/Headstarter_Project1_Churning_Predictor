...
def explain_prediction(probability, input_dict, surname):
  ...
  Your machine learning model has predicted that a customer {surname} has a {round(probability*100,1)}% probability of churning, based on the information provided below.
...
- If the customerhas over a 40% risk of churning, generate a 3 sentence explanation of why they are at risk of churning.
...
def generate_email(probability, input_dict, explanation, surname):
  ...
  Generate an e-mail to the customer based on their information, asking them to stay if they are at risk of churning, or offering them incentives so that they become more loyal to the bank.
